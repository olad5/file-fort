...
func NewPostgresFileRepo(ctx context.Context, connection *sqlx.DB) (*PostgresFileRepository, error) {
  ...
  CREATE TABLE IF NOT EXISTS files(
      ...
      file_store_link varchar(255) NOT NULL,
...
func (p *PostgresFileRepository) GetFileByFileId(ctx context.Context, fileId string) (domain.File, error) {
	var file SqlxFile
...
type SqlxFile struct {
	...
	FileStoreLink string    `db:"file_store_link"`
